...
| [`errors`](./src/errors/README.md)                                                 | Namespaced, serializable error classes grouped into domains with `instanceof`      | [→](./src/errors/README.md)                         |
...
| [`signal`](./src/signal/README.md)                                                 | Push-based reactive state with explicit watchers and `signal.from` adapters        | [→](./src/signal/README.md)                         |
